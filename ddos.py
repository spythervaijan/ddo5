...
OWNER_ID = 5193826370   # CHANGE THIS
...
async def attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    global attack_running, attack_end_time, attack_info
    ...
    try:
        ...
        page.get_by_role("textbox", name="104.29.138.132").fill(ip)
        page.get_by_role("textbox", name="80").fill(port)
        page.get_by_role("textbox", name="60").fill(str(duration))
