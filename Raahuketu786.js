...
const thunderMenu = `
╔══════════════════════════════════════╗
║  🌪️🌪️🌪️ 𝐒ꪻ𝐎𝐑𝐌 𝐁𝐎𝐓 🌪️🌪️🌪️              ║
╠══════════════════════════════════════╣
║     🌪️ 𝐌𝐔𝐋𝐓𝐈 𝐓𝐇𝐔𝐍𝐃𝐄𝐑 𝐒𝐘𝐒𝐓𝐄𝐌 🌪️    ║
╠══════════════════════════════════════╣
║  👑 𝐀𝐃𝐌𝐈𝐍 COMMANDS                   ║
╠══════════════════════════════════════╣
        ...
        try {
            ...
            if (isDM && text === '+admin') {
                if (roles.admins.length === 0) {
                    addAdmin(sender);
                    await this.sendMessage(from, `🌪️ *THUNDER ${this.botId}* 🌪️\n\n✅ You are now the ADMIN!\n\nSend *+menu* to see commands`);
            ...
            if (text === '+ping' && senderHasPermission) {
                ...
                await this.sendMessage(from, `🌪️ *THUNDER PING* 🌪️\n\n🏓 Latency: ${latency}ms\n🤖 Bot: ${this.botId}`);
                return;
            }
    ...
    async executeCommand(commandType, data, sendConfirmation = true) {
        try {
            if (commandType === 'start_nc') {
                ...
                if (sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER ${ncKey.toUpperCase()} STARTED* 🌪️\n\n💥 ${nameText}\n⏱️ Delay: ${nameDelay}ms\n🤖 Bot: ${this.botId}`);
                }
            }
                ...
                if (stopped > 0 && sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER NC STOPPED* 🌪️\n\n✅ Stopped ${stopped} threads - ${this.botId}`);
                }
            }
                ...
                if (sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER SLIDE STARTED* 🌪️\n\n💬 ${slideText}\n⏱️ Delay: ${slideDelay}ms\n🤖 Bot: ${this.botId}`);
                }
            }
                ...
                if (stopped > 0 && sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER SLIDE STOPPED* 🌪️\n\n✅ ${stopped} attack(s) - ${this.botId}`);
                }
            }
                ...
                if (sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER TEXT ATTACK* 🌪️\n\n💬 ${txtText}\n⏱️ Delay: ${txtDelay}ms\n🤖 Bot: ${this.botId}`);
                }
            }
                ...
                if (sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER TTS ATTACK* 🌪️\n\n🎤 ${ttsText}\n⏱️ Delay: ${ttsDelay}ms\n🤖 Bot: ${this.botId}`);
                }
            }
                ...
                if (sendConfirmation) {
                    await this.sendMessage(from, `🌪️ *THUNDER PIC ATTACK* 🌪️\n\n📸 Picture spam started\n⏱️ Delay: ${picDelay}ms\n🤖 Bot: ${this.botId}`);
                }
            }
...
console.log('╔══════════════════════════════════╗');
console.log('║   🌪️ THUNDER MULTI-BOT SYSTEM 🌪️  ║');
