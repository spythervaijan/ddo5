...
# ---------------------------
TOKENS = [
"8425412553:AAEhJPyqbhDcC36oYegLiWFkFlnUTsGP9cw",
"8314764041:AAFpN-5bfu64zSkAsJv1vwWtqpPtHbotwMc",
"7831035698:AAFz4x8WMAo7wtxgbqIxAdbger6ACqpROO8",
"8213811628:AAG6-nkqZ-qnzTtQD-z68GyI-l0-Uspcr9w",
"8317194459:AAE2I0MxhtEWDYzn7cFamDjbwdL8nwlHPZk",
"8336818768:AAFEcZogYMq2yC8wwyo8HISEm3-_QRdTfBk",
"8525408103:AAEWkrzIxseTXbKAiavlIBqQ_dSqskQspz4",
"8626923208:AAFgi8wMTJ-BMGXdBfaS7e5xHmE_TM5cwoY",
"8255044499:AAFLkp8wk55y-r2Qu7ecos_ON-G7yvn-gXs",
"8706648158:AAGQLGHHhZVBaidjOD2zuL53OgWi1ASeqLI",
]

CHAT_ID = 8552490143
OWNER_ID = 8552490143
SUDO_FILE = "8552490143"
...
CSWORD_TEXTS = [
    ...
    "BAAP BANA N3XA KO", "TU MERA BETA", "OYE RANDY", "MAR GYA"
]
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🪷N3XA TG NC— Commands 🪷\nUse -help")
...
async def raidspam_loop(bot, chat_id, cmd_text):
    ...
    patterns = [
        ...
        "𝑁𝐸𝑋𝐴 𝐵𝑂𝑇 𝐾𝐸 𝐴𝐴𝐺𝐸 𝑇𝐸𝑅𝐼 𝑀𝐴𝐴 𝑁𝐴𝑁𝐺𝐼 {name} {emo}🔥"
    ]
    while True:
        try:
...
async def beta_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not update.message.reply_to_message:
        return await update.message.reply_text("⚠️ Reply to a user to make them nexa's son")
    
    uid = update.message.reply_to_message.from_user.id
    SUDO_USERS.add(uid)
    save_sudo()
    await update.message.reply_text(f"✅ This user is now nexa's son")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n🛑 Nexa V11 Extreme Shutting Down...")
    except Exception as e:
        print(f"❌ Error: {e}")
