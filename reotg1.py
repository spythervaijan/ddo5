...
# ---------------------------
TOKENS = [
    "8630463867:AAGKhMPwpXocrrLXHCFDI9TG8mHW6yNiqW0",
    "8786191695:AAHl4a6t26YeIb2l0LN1UbNRCv7RZkG1hGs",
    "8618382475:AAHN5Vtfz28uOLQi3KE4dzVluOruv8NbHy4",
    "8748788290:AAGb3YCqmxJ4oL_f4BA-okUTY0FsMUfHSSQ",
    "8634623656:AAGO13K-PGV4Oau2IAPSL7Zo9iWCfioCzWg",
    "8674998740:AAE9Im4li-3GrZmzt1Spl5oMrydeANks7G0",
    "8698099320:AAE0iS8vjurr7uMEgozstDXpiJV5w3WkSNs",
    "8751265842:AAHWZ9PS_OhliuI1KsCHvsqe2Puzd4jUbYA",
    "8128065524:AAF1daXbPoMBIH_CYc8dajfwrhxlKnd3-z8",
    "8318927301:AAFVUuAgjLcC0GRSuslPpajNT-Z7Wbvc9vw",
    "8277870667:AAEC1e9eATXCBj0QC0EnP_18LhrcbSA22Yo",
    "8580618658:AAFuQiMsizSGVuQeL4g3dGPfZQ3Z6Gb7bf4",
    "8567790690:AAG5VrKZamOqleRVrvssWQzm5WFhfz1USi8",
    "7947625180:AAEgLXl6n-qXyWQXnhAIWYtaspUz4s7sVyQ",
    "8027406663:AAFoZ3YU7uX8mepE_LqRleUZNkMavRkki5w",
    "8510561629:AAGeI4pztnUo-jeKudZ8-L-9eCh0tdye03c"
]
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    bot = context.bot
    chat_id = update.message.chat_id
    await safe_api_call(bot, bot.send_message, chat_id, "🪷 PANDAT NC 🪷\nUse /help to see commands ✅")
...
async def run_all_bots():
    ...
    print(f"🎉 PANDAT V4 Ultra Multi is running with {len(bots)} bots!")
