...
const CONSTANT_WORDS = [
    'KI MA CHINAAL🐿️',
    'CHAL RNDYKE PAIRO ME GIRKE NAAK RAGD🐦‍🔥', 
    'BOLE RAHuLPAPA MUJHE MAAF KR DO🦕',
    'KI MA KARE BHAW BHAW🦐',
    'KI BEHEN KI CHUT LAAL PILI🐚',
    'KI BUA RANDI🐡',
    'KI MA LANGDI🐬',
    'GAREEB KA BACHHA🦡',
    'CHAL BHEEKH MANG🐾',
    'CHUD KE PAGAL HOGAYA👻',
    'HELLO MARNA NHI HAI MADHARCHOD🕷️',
    ' BOLE RAHuLPAPA MERI MA CHOD DO🦋',
    'SALE ADIVASI KE LADKE🐣'
];
